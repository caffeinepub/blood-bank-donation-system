...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Connect donors with those in need through our secure,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A comprehensive blood bank management system built with modern
              technology
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {features.map((feature) => (
              <Card
                key={feature.title}
                className="border-border hover:border-primary/20 transition-all duration-300 hover:shadow-lg"
              >
                <CardHeader>
      ...
      <section className="py-16 bg-gradient-to-br from-primary/5 via-background to-primary/3 border-y border-border">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Join thousands of registered donors. Takes less than 5 minutes
                to register — your contribution can be life-changing for someone
                in need.
              </p>
            ...
            <div className="grid grid-cols-2 gap-3 flex-shrink-0">
              {[
                ...
                { label: "Lives Saved", value: "36,000+" },
                { label: "Cities Covered", value: "120+" },
                { label: "Hospitals Served", value: "500+" },
              ].map((stat) => (
                <div
                  key={stat.label}
                  className="bg-card border border-border rounded-xl p-4 text-center min-w-[110px]"
                >
      ...
      <section
        id="emergency"
        className="py-20 bg-gradient-to-br from-destructive/5 to-background"
      >
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto border-destructive/20 bg-card">
            <CardHeader className="text-center pb-8">
              ...
              <CardDescription className="text-lg mt-2">
                Submit an emergency request and we'll notify available donors
                immediately
              </CardDescription>
            </CardHeader>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="text-center text-lg leading-relaxed">
                Our blood bank management system leverages blockchain technology
                to ensure data security, transparency, and reliability. Every
                donation, request, and transaction is securely recorded on the
                Internet Computer, making it tamper-proof and always accessible
