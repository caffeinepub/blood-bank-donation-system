...
export default function DonorLayout({ children, currentPage }: DonorLayoutProps) {
  ...
  const navItems = [
    ...
    { icon: Bell, label: 'Notifications', href: '#', id: 'notifications', badge: unreadCount },
  ];
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="left" className="w-72">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="font-display font-bold text-lg">BloodBank</span>
                </div>
                <NavContent mobile />
              </SheetContent>
            </Sheet>
